...
void mult(const CSRMatrix& A, const Vector& x, Vector& y, size_t parts) { A.matvec(x, y, parts); }      // Fixed
...
void mult(const CSCMatrix& A, const Vector& x, Vector& y, size_t parts) { A.matvec(x, y, parts); }      // Fixed
