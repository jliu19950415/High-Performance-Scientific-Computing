...
std::complex<double> f(std::complex<double> x)  { return pow(x,6.0) + 13.0 * pow(x,4.0) - 11.0; }  // f(x) = x^6 + 13x^4 - 11
std::complex<double> fp(std::complex<double> x) { return 6.0 * pow(x,5.0) + 52.0 * pow(x, 3.0); }  // derivative of f
